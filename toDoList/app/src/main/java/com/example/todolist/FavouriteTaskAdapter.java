...
public class FavouriteTaskAdapter extends ArrayAdapter<Task> {
    ...
    public FavouriteTaskAdapter(@NonNull Context context, int resource, List<Task> taskList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.popupMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupMenu.getMenuInflater().inflate(R.menu.popup_menu_favourite_tasks, popupMenu.getMenu());
                popupMenu
